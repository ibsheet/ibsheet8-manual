...
> `제약사항`  
> ① RTL은 시트 생성 시점에 적용되어야 하며, 생성 이후 동적으로 켜고 끌 수는 없습니다.  
> ② `exportData` / `down2Excel` 로 엑셀 다운로드 시에는 화면에 아라비아 숫자가 아닌 다른 숫자 체계(예: `٠١٢٣٤٥٦٧٨٩`)로 표시되고 있어도 엑셀 파일에는 **아라비아 숫자(`0~9`)** 로 다운로드 됩니다.
>

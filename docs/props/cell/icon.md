...
<!-- synonyms: Icon, 아이콘, 셀 아이콘, 좌측 아이콘, 체크박스, 버튼, cell icon, checkbox, 삭제 아이콘, Clear, Expand, Date 아이콘, 달력 아이콘, 셀 이미지 -->
...
###
![Icon속성](/assets/imgs/Icon1.png "Icon속성")<br/>[그림1]<br/>
![Icon속성](/assets/imgs/Icon2.png "Icon속성")<br/>[그림2]<br/>
...
|`기타`|이미지 파일에 대한 url을 넣으면 아이콘의 배경으로 이미지가 표시됩니다. [그림1] 참고<br/>(이미지는 gif,png,jpg만 가능)|
<!--!
|`[비공개]` `Expand`|접음/펼침 기능을 사용하기 위한 버튼이 표시됩니다.|
!-->

*[IconWidth](../col/icon-width) 속성을 통해 아이콘 영역의 넓이를 설정할 수 있습니다.<br/>아이콘을 클릭시 [onIconClick](/docs/events/on-icon-click)이벤트가 호출됩니다.<br/>`"Clear"`나 `"Check"`로 설정하면 [OnClickSide](/docs/props/event/on-click-side) 이벤트만 호출합니다.*

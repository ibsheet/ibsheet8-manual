...
>
> 멀티레코드([MultiRecord](/docs/props/cfg/multi-record)) 기능을 `2`로 설정하여 사용할 경우 [Header](/docs/props/col/header)를 `object`형태로 사용하여, `Header.RecordRowSpan`을 통해 특정 행을 기준으로 아래쪽으로 합쳐질 행의 개수를 설정하실 수 있습니다.

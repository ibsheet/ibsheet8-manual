...
> 선택된 영역에는 반드시 `Int`, `Float`의 숫자형 열을 포함해야 합니다.  
...
|----------|-----|---|----|
|chartType|`string`|<span class='optional'>선택</span>|차트의 종류 (`default: line`)|
<!--!
|`[비공개]`exrtaOpt|`object`|<span class='optional'>선택</span>|chart에 대한 초기 설정 ([IBChart 참고](https://docs.ibsheet.com/ibchart/v1/manual/#docs/intro/feature))|
!-->

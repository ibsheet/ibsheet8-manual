...
|widthRate|`number`|<span class='optional'>선택</span>|엑셀 다운로드 시 **모든 열 너비에 곱할 배율**입니다.<br/>`0`보다 크면 그 배율대로 적용됩니다. (예: `0.5` → 절반, `0.8` → 80%, `1.3` → 130%)<br/>`0` 이하이거나 미지정이면 `1`(기본 크기)로 적용됩니다. (`default: 1`)|
<!--!

...
> (cfg)[SearchMode](/docs/props/cfg/search-mode)의 값이 0이 아닌 경우, 시트는 데이터 행들을 (cfg)[PageLength](/docs/props/cfg/page-length)에서 부여한 갯수 단위로 묶어서 관리합니다.<br>
> 이때 [페이지 객체](/docs/appx/page-object)의 개념이 생겨나는데, [페이지 객체](/docs/appx/page-object)는 자신이 갖고 있는 행들 중 첫번째 행과 마지막 행,그리고 이전 페이지와 다음 페이지에 대한 링크를 갖고 있습니다.<br/>
> 특히 페이지 네비게이션을 갖는 SearchMode:4를 사용하는 경우에는, [goToPage()](/docs/funcs/core/go-to-page)와 같은 함수를 통해 페이지 단위로 이동할 수 있습니다.<br/><br/>
